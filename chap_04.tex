...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Nv-architecture-globale2.jpg}
\caption{Architecture globale en 7 couches du système (représentation académique)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagramme-classes.png}
\caption{Diagramme de classes UML — les 9 entités du système et leurs relations}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{diagramme-sequence.png}
\caption{Diagramme de séquence — flux nominal d’une session chatbot (11 étapes)}
...
\hline
odoo-service & odoo:17 & Progiciel ERP Odoo — gestion des événements et utilisateurs & 8069 \\
\hline
