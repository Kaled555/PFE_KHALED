...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig31-vitrine.png}
\caption{Vitrine événementielle — AI Healthcare Summit 2025 (23–26 Avril 2026)}
\label{fig:vitrine}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig32-formulaire.png}
\caption{Formulaire d’inscription avec validation côté client}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig37-email-confirmation.png}
\caption{Email de confirmation d’inscription reçu dans Gmail}
\label{fig:email_confirmation}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig36-email-j2.png}
\caption{Email de rappel J-2 — en-tête AI Healthcare Summit 2025}
\label{fig:email_j2}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig36b-email-j2-boutons.png}
\caption{Email de rappel J-2 — boutons d’accès directs aux 4 tracks scientifiques}
\label{fig:email_j2_boutons}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{visioconference-03-ia.png}
\caption{Interface du chatbot IA — widget accessible depuis toutes les pages de la plateforme}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{visioconference-00-overview.png}
\caption{Réponse générée par le chatbot IA — conservation du contexte conversationnel}
\label{fig:chatbot_context}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{visioconference-05-admin.png}
\caption{Chatbot IA en mode organisateur — réponse adaptée au rôle RBAC}
\label{fig:chatbot_organizer}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig38-rgpd-export.png}
\caption{Export RGPD — résultat de la commande curl /api/healthcare/rgpd/export}
\label{fig:rgpd_export}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{fig39-rgpd-delete.png}
\caption{Suppression RGPD — résultat de la commande curl /api/healthcare/rgpd/delete}
\label{fig:rgpd_delete}
\end{figure}
