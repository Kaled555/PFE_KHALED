...
Ce chapitre présente l'état de l'art des domaines technologiques et scientifiques mobilisés par le projet. Son objectif est double : fournir les fondements conceptuels nécessaires à la compréhension des choix techniques, et situer la solution proposée dans son contexte scientifique et technologique plus large. La revue bibliographique est structurée selon le plan suivant :

\begin{enumerate}
    \item Concepts Fondamentaux de la Cybersécurité (CIA, chiffrement, authentification, modélisation des menaces)
    \item Gestion des Incidents de Sécurité (cycle de vie, indicateurs TTD/TTR, conformité RGPD)
    \item Supervision Réseau (principes, protocoles, architectures)
    \item Intelligence Artificielle Conversationnelle (NLP, chatbots, agents de traduction)
    \item SOC et SIEM (perspectives opérationnelles et évolution future)
\end{enumerate}
