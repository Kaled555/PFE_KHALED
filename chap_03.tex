...
Ce chapitre formalise l'ensemble des exigences du système, puis établit la traçabilité entre ces exigences et les choix technologiques retenus. Sa structure s'organise autour des points suivants :

\begin{enumerate}
    \item Identification des Acteurs (Organisateur, Participant, Administrateur, Agent IA, Odoo)
    \item Extraction des Besoins Globaux (fonctionnels et non-fonctionnels)
    \item Diagramme de Cas d'Utilisation (modélisation UML)
    \item Planification du Projet (backlog et organisation des sprints)
    \item Étude Stratégique (technologies, environnements, justifications)
    \item Architecture Globale (présentation macroscopique du système)
\end{enumerate}

L'objectif est de fournir une vue d'ensemble cohérente et traçable de l'architecture, garantissant que chaque composant technique répond à une exigence métier clairement établie.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{visioconference-00-overview.png}
\caption{Diagramme de cas d'utilisation — Vue d'ensemble du système (5 packages)}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{visioconference-01-events-auth.png}
\caption{Diagramme de cas d'utilisation — Gestion des Événements et Authentification}
\label{fig:events_auth}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{visioconference-02-meeting.png}
\caption{Diagramme de cas d'utilisation — Déroulement des Réunions Virtuelles}
\label{fig:meetings}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{visioconference-03-ia.png}
\caption{Diagramme de cas d'utilisation — Intelligence Artificielle (Chatbot et Traduction)}
\label{fig:ia_usecases}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{visioconference-04-rgpd.png}
\caption{Diagramme de cas d'utilisation — Gestion RGPD et Données Personnelles}
\label{fig:rgpd_usecases}
\end{figure}
